...
func (DefaultCompositionRef) Help() *markers.DefinitionHelp {
	return &markers.DefinitionHelp{
		Category: "XRD",
		DetailedHelp: markers.DetailedHelp{
			Summary: "DefaultCompositonRef - specifies the name of the default comopsition",
			Details: "used for the XRD and whether it is enforced\nname=string\nenforced=bool",
		},
		FieldHelp: map[string]markers.DetailedHelp{
			"Name": {
				Summary: "is required",
